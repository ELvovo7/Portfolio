...
<li>тестирование прерываний и установки. </li>
<br>
Также была составлена тестовая документация, включающая функциональное тестирование и специальные проверки мобильного приложения. В результате проведенных тестов был составлен отчет о тестировании.
<br>
